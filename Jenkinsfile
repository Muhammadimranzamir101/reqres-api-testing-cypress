...
node {
	try {
		...
		properties([
			parameters([
				credentials(credentialType: 'com.browserstack.automate.ci.jenkins.BrowserStackCredentials', defaultValue: '', description: 'Select your BrowserStack Username', name: 'muhammadimran_MHX6Zj', required: true),
...
bstack-local-parallel-browsers''',
		...
		stage('Pull from Github') {
			dir('test') {
				git branch: 'main', changelog: false, poll: false, url: 'https://github.com/Muhammadimranzamir101/reqres-api-testing-cypress'
			}
		}
